...
im_width = 224  # 输入图片的宽
model_name = "Resnet" # 模型名称"AlexNet"、"VGG"、"Googlenet","Resnet","MobilenetV3"、"Shufflenet"
img_path = r"D:\模式识别\Fish_recognition-main\fish_data\test\jinyu_7.jpg"# 预测的图片
# ------------------------------------------------------------------------------------# 
# 加载图片
...
weighs_path = "./save_weights/myResnet.h5"
